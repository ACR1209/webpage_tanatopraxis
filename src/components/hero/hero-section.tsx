...
function HeroSection() {
  return (
    <section id="home" className="min-h-screen px-5 xl:px-0 py-14 relative  bg-gray-300">
        <Image
        ...
        <div className="flex z-10 flex-col h-full items-center">
          <div className="w-full text-center  z-10 xl:w-1/2 gap-2 flex flex-col">
            <h1 className="text-5xl font-black">
              Conviertete en un <b className='bg-primary text-white px-2'>experto</b> en Tanatopraxia y Tanatoestética
            </h1>
            <p>
